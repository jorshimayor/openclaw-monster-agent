    ...
    <html lang="en" className={`dark ${jb.variable} ${inter.variable}`}>
      <body className="bg-bg text-matrix font-mono antialiased min-h-screen flex">
        ...
        <div className="flex-1 flex flex-col min-w-0">
          <header className="h-14 border-b border-bg-border bg-bg-panel px-6 flex items-center justify-between shrink-0">
            <div className="flex items-center gap-4 text-xs">
              <span className="flex items-center gap-2">
                <span className="w-2 h-2 rounded-full bg-matrix animate-pulse-matrix"></span>
                <span className="text-matrix-dim">CONN:</span>
                <span className="tracking-wider">ws://localhost:8000</span>
              </span>
            </div>
            <div className="flex items-center gap-6 text-xs text-matrix-dim">
              <span>SESSION: 0xA1B2C3D4</span>
